...
class StreamController extends SuperController {
    constructor() {
        super();

        /** */
        this.model = this.get_model('Stream');
    }
    ...
    async create_record(data) {
        try {
            ...
            console.log(`[StreamController] create_record Error: ${e.message}`);
        }
    }
    ...
    async read_records(conditions, fields_to_return = '', sort_options = '', skip = 0, limit = Number.MAX_SAFE_INTEGER) {
        try {
            ...
            console.log(`[StreamController] read_records: ${e.message}`);
        }
    }
    ...
    async update_records(conditions, data_to_set) {
        try {
            ...
            console.log(`[StreamController] update_records Error: ${e.message}`);
        }
    }
    ...
    async delete_records(conditions) {
        try {
            ...
            console.log(`[StreamController] delete_records Error: ${e.message}`);
        }
    }
}
